...
unit_circle.addEventListener('click', function (e) {
    if (document.getElementById('remove').checked) { 
        ...
        zero.style = `background-color: black; width: 15px; height: 15px;position: absolute;top:${e.clientY}px;left:${e.clientX}px; border-radius: 50%;z-index:100`
        ...
        id_conter++;
            ...
            pole.innerHTML = '✖';
            pole.style = `color:black; width: 20px; height: 20px;position: absolute;top:${e.clientY}px;left:${e.clientX}px;`
